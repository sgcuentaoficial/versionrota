        ...
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-gold to-yellow-400 p-4 flex items-center">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-black">Asistente VIP</h3>
                        ...
                        <div className="mt-3 space-y-2">
                          {message.options.map((option, index) => (
                            <button
                              ...
                              className="block w-full text-left px-3 py-2 bg-gray-100 hover:bg-gold/20 rounded-lg text-sm font-medium transition-colors border border-gray-200 hover:border-gold/30"
                            >
                              {option}
                            </button>
                          ))}
          ...
          <div className="p-4 border-t border-gray-200 bg-white">
            <div className="flex items-center space-x-2">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 rounded-xl focus:border-gold focus:ring-2 focus:ring-gold/20 outline-none text-sm"
              />
              <button
                onClick={handleSendMessage}
                disabled={!inputValue.trim()}
                className="w-12 h-12 bg-gold hover:bg-yellow-400 disabled:bg-gray-300 rounded-xl flex items-center justify-center transition-colors"
              >
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              <button
                ...
                className="px-3 py-1 bg-gold/10 hover:bg-gold/20 text-gold text-xs font-medium rounded-full border border-gold/30 transition-colors"
              >
                📞 Consulta VIP
              </button>
              <button
