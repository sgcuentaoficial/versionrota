    ...
    <section ref={sectionRef} className="py-32 bg-gray-900">
      <div className="container mx-auto px-4">
        <div className={`max-w-7xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              >
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                    <div className="relative">
                      <Quote className="w-12 h-12 text-vip-gold/20 mb-6" />
                      
                      <blockquote className="text-2xl text-gray-300 mb-8 leading-relaxed italic">
                        "{testimonial.quote}"
                      </blockquote>
                      
                      <div className="border-l-4 border-vip-gold pl-6">
                        ...
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <Star key={i} className="w-5 h-5 text-vip-gold fill-current" />
                          ))}
          ...
          {/* Disclaimer */}
          <div className="mt-16 pt-8 border-t border-vip-gold/20">
